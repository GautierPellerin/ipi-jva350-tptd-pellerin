...
public class SalarieAideADomicile {
	...
	public SalarieAideADomicile(String nom, LocalDate moisDebutContrat, LocalDate moisEnCours,
			...
			double joursTravaillesAnneeN, double congesPayesAcquisAnneeN, double joursTravaillesAnneeNMoins1,
			double congesPayesAcquisAnneeNMoins1, double congesPayesPrisAnneeNMoins1) {
		this.nom = nom;
	 ...
	 * juin de l'année N au 31 mai de l'année N - 1. NB. on considère que la
	 * précédente ligne est correcte d'un point de vue des spécifications métier
	...
	public LinkedHashSet<LocalDate> calculeJoursDeCongeDecomptesPourPlage(LocalDate dateDebut, LocalDate dateFin) {
		...
		if (dateDebut.getDayOfWeek().getValue() != DayOfWeek.SUNDAY.getValue() && !Entreprise.estJourFerie(dateDebut)
				&& estHabituellementTravaille(dateDebut)) {
	...
	/*
	 * public double getCongesPayesRestantAnneeNMoins1() { return
	 * congesPayesRestantAnneeNMoins1; }
	 * 
	 * public void setCongesPayesRestantAnneeNMoins1(double
	 * congesPayesRestantAnneeNMoins1) { this.congesPayesRestantAnneeNMoins1 =
	 * congesPayesRestantAnneeNMoins1; }
	 */
